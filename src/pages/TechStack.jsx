...
const TechStack = () => {
  ...
  return (
    ...
    >
      ...
      <section className="relative w-full max-w-screen-6xl px-6 md:px-32 py-5">
        <div className="mx-auto py-3 my-4">
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <div className="w-full md:w-1/2">
              ...
              <motion.button
                className="mt-4 px-2 py-0.25 bg-blue-600 text-white rounded-lg font-semibold hover:bg-blue-700 transition-colors text-xs"
            ...
            <div className="w-full md:w-1/2 mt-10 md:mt-0 z-60">
              {[
